...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnAc,btnDel,btnIgual,btnParentesis1,btnParentesis2,btnPunto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            ...
            lstNumeros.add((Button) findViewById(R.id.btnParentesisOpen));
            lstNumeros.add((Button) findViewById(R.id.btnParentesisClose));
